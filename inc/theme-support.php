...
function sunset_post_navigation(){
	...
	$prev = get_previous_post_link( '<div class="post-link-nav"><span class="sunset-icon sunsetchevron-left" aria-hidden="true"></span> %link</div>', '%title' );
	$nav .= '<div class="col-xs-12 col-sm-6">' . $prev . '</div>';
	
	$next = get_next_post_link( '<div class="post-link-nav">%link <span class="sunset-icon sunsetchevron-right" aria-hidden="true"></span></div>', '%title' );
...
function sunset_share_this( $content ){
	...
	if( is_single() ){
		...
		$content .= '<ul>';
		$content .= '<li><a href="' . $twitter . '" target="_blank" rel="nofollow"><span class="sunset-icon sunsettwitter"></span></a></li>';
		$content .= '<li><a href="' . $facebook . '" target="_blank" rel="nofollow"><span class="sunset-icon sunsetfacebook"></span></a></li>';
		$content .= '<li><a href="' . $google . '" target="_blank" rel="nofollow"><span class="sunset-icon sunsetgoogle"></span></a></li>';
...
function sunset_get_post_navigation() {
 	// if(get_comment_pages_count() > 1 && get_option('page_comments')): 
 		require_once(get_template_directory() . '/inc/templates/sunset-comment-nav.php');
 	// endif;
}
...
function mailtrap($phpmailer) {
  ...
  $phpmailer->Port = 2525;
  $phpmailer->Username = '1bdddd755b51ae';
  $phpmailer->Password = 'fd421a1ae8904f';
}
